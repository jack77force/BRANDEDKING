...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("toxic_mod_vip")
                await self.one.join_chat("toxic_mod_vip")
                await self.one.join_chat("TOXIC_WORLD8")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("toxic_mod_vip")
                await self.two.join_chat("toxic_mod_vip")
                await self.one.join_chat("TOXIC_WORLD8")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("toxic_mod_vip")
                await self.three.join_chat("toxic_mod_vip")
                await self.one.join_chat("TOXIC_WORLD8")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("toxic_mod_vip")
                await self.four.join_chat("toxic_mod_vip")
                await self.one.join_chat("TOXIC_WORLD8")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("toxic_mod_vip")
                await self.five.join_chat("toxic_mod_vip")
                await self.one.join_chat("TOXIC_WORLD8")
            except:
                pass
